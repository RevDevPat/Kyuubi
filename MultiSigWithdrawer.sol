...
contract MultiSigWithdrawer  is Ownable {
    ...
    event MultiSigWithdraw(address to, address tokenAddress, uint amount);
    ...
    function multiSigWithdraw(address to, address tokenAddress, uint amount) external  onlyMultisig {
        if (amount > 0 && to != address(0)) {
            ERC20(tokenAddress).safeTransfer(to, amount); 
            emit MultiSigWithdraw(to, tokenAddress, amount);
        }
